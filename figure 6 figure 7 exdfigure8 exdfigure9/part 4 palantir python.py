...
palantir.plot.plot_cell_clusters(fdl, meta_data["cell.type"])
plt.savefig('./fdl_cell.type.png')

meta_data_mono = meta_data[meta_data["cell.type"] == "monocytes"]
meta_data_mono

#running palantir
start_cell = "ACACCAAGTAGTATAG-1_1"
...
df["ClusterName"] = list(meta_data["cell.type"])
